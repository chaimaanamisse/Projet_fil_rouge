...
class Form 
{
    private $formCode = '';  // une fois qu'on va avoir génerer notre formulaie il va etre stocker à l'interieur d'une propriéte $formCode donc la première fois qu'on  arrivera et instancira notre formCode va etre vide
    ...
    // $form tableau reçue du formuaire($_POST,$_GET)
    // $champs tableau listant les champs obligatoires
    // return un booléen

    public static function validate(array $form, array $champs)   // le static c'est pour l'interroger sans instancier l'objet
    {
        // On parcourt les champs
        foreach($champs as $champ){
            // Si le champ est absent ou vide dans le formulaire
            if(!isset($form[$champ]) || empty($form[$champ])){
                // on sort en retournat false
                return false;
            }
        }
        return true;
    ...
    // array $attributs tableau associatif ['class' =>'form-control, 'required => true]
    ...
    //   string $methode Méthode du formulaire (post ou get)
    //   string $action Action du formulaire
    //   array $attributs Attributs
    //   return Form 
